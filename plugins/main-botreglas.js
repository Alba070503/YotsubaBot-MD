...
let rei = `🍁 *Respeta las reglas de Rei Ayanami-Bot*\n
✰ No llamar Al Bot
✰ No hacer spam
...
𝗔𝘃𝗶𝘀𝗼: *Puedes apoyarnos dejando una estrellita 🌟 al repositorio oficial de Rei Ayanami.*

${global.md}`.trim()
await conn.reply(m.chat, rei, m, rcanal, )

...
await conn.sendMessage(m.chat, {text: txt1, mentions: [...txt1.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), contextInfo: { mentionedJid: [...txt1.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), "externalAdReply": {"showAdAttribution": true, "containsAutoReply": true, "renderLargerThumbnail": true, "title": global.packname, "body": `ꪶໍٜ߭۫ި᮫ׅ࣪۬߭ׄ𖾏🍨𝚮͜ᴏ፝ʟ⃨ᴀ⃨⃕🍫`, "containsAutoReply": true, "mediaType": 1, "thumbnail": img, "mediaUrl": `https://whatsapp.com/channel/0029VaAN15BJP21BYCJ3tH04`, "sourceUrl": `https://whatsapp.com/channel/0029VaAN15BJP21BYCJ3tH04`}}})
